...
public class IAPKey
{
    public const string PACK1 = "aku_sayang_pack_1";
    public const string PACK2 = "aku_sayang_pack_2";
    public const string PACK3 = "aku_sayang_pack_3";
    public const string PACK4 = "aku_sayang_pack_4";
    public const string PACK5 = "aku_sayang_pack_5";
    public const string PACK6 = "aku_sayang_pack_6";

    public const string PACK1_REGISTER = "aku_sayang_pack_register_1";
    public const string PACK2_REGISTER = "aku_sayang_pack_register_2";
    public const string PACK3_REGISTER = "aku_sayang_pack_register_3";
    public const string PACK4_REGISTER = "aku_sayang_pack_register_4";
    public const string PACK5_REGISTER = "aku_sayang_pack_register_5";
}
